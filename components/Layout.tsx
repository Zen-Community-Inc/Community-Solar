        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Clean, affordable energy for Illinois communities.
              </p>
              <div className="flex gap-3">
                {/* Twitter / X */}
                {/* <a href="https://web.facebook.com/profile.php?id=61582442685007" className="text-gray-400 hover:text-yellow-500 transition-colors">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/zendirect2025/" className="text-gray-400 hover:text-yellow-500 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-xs text-gray-500">
              © {new Date().getFullYear()} Zen Community Solar. All rights reserved.
            </p>
            <p className="text-xs text-gray-500">
              Made with ♥ in Miramar Florida
            </p>
          </div>
        </div>
      </footer>
